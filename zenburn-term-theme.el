;;; zenburn-term-theme.el --- A low contrast color theme for Emacs.
...
(deftheme zenburn-term "The Zenburn color theme for terminal users")
...
;;;;; flycheck
   `(flycheck-error ((,class (:foreground ,zenburn-red-1 :weight bold :underline t))))
   `(flycheck-warning ((,class (:foreground ,zenburn-yellow-1 :weight bold :underline t))))
   `(flycheck-info ((,class (:foreground ,zenburn-cyan :weight bold :underline t))))
